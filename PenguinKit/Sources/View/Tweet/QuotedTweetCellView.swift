...
struct QuotedTweetCellView_Previews: PreviewProvider {
  static var previews: some View {
    QuotedTweetCellView(tweet: .init(id: "id", text: "text"), user: .init(id: "id", name: "name", userName: "userName", profileImageURL: URL(string: "https://pbs.twimg.com/profile_images/974322170309390336/tY8HZIhk_400x400.jpg")))
  }
}
