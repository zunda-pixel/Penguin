...
struct SelectReplyUsersView_Preview: PreviewProvider {
  struct Preview: View {
    ...
    let users: [Sweet.UserModel] = [
      .init(
        id: "1", name: "name1", userName: "name1",
        profileImageURL: URL(
          string: "https://pbs.twimg.com/profile_images/1605096515281641472/XDbwQ_h6_400x400.jpg")),
      .init(
        id: "2", name: "name2", userName: "name2",
        profileImageURL: URL(
          string: "https://pbs.twimg.com/profile_images/1605096515281641472/XDbwQ_h6_400x400.jpg")),
      .init(
        id: "3", name: "name3", userName: "name3",
        profileImageURL: URL(
          string: "https://pbs.twimg.com/profile_images/1605096515281641472/XDbwQ_h6_400x400.jpg")),
      .init(
        id: "4", name: "name4", userName: "name4",
        profileImageURL: URL(
          string: "https://pbs.twimg.com/profile_images/1605096515281641472/XDbwQ_h6_400x400.jpg")),
      .init(
        id: "5", name: "name5", userName: "name5",
        profileImageURL: URL(
          string: "https://pbs.twimg.com/profile_images/1605096515281641472/XDbwQ_h6_400x400.jpg")),
      .init(
        id: "6", name: "name6", userName: "name6",
        profileImageURL: URL(
          string: "https://pbs.twimg.com/profile_images/1605096515281641472/XDbwQ_h6_400x400.jpg")),
    ]
